...
return [
    ...
    */
    ...
    'ascii' => ':attribute повинен містити лише однобайтові буквено-цифрові символи та символи.',
    ...
    'confirmed' => 'Поле :attribute не збігається.',
    ...
    'decimal' => ':attribute повинен мати :decimal знаків після коми.',
    ...
    'unique' => 'Цей :attribute вже використано.',
    'uploaded' => 'Не вдалося завантажити :attribute.',
    'uppercase' => 'Поле :attribute має бути великим регістром.',
    ...
    */
    ...
    'custom' => [
            'name' => [
            'requiredMessage' => 'Будь ласка, заповніть це поле1'
            ]
    ],
